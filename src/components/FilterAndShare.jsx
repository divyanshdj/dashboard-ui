...
const FilterAndShare = () => {
  const [showFilter, setShowFilter] = useState(false);
  const [showDateFilter, setShowDateFilter] = useState(false);

  return (
    <div className="flex space-x-2 flex-row item-center justify-between w-full mt-1 relative">
      <div className="flex items-center space-x-2 mx-9 relative">
        <div className="relative">
          <button
            onClick={() => setShowFilter((prev) => !prev)}
            className="flex flex-row items-center justify-center px-4 py-3 gap-2 text-xl border-2 border-gray-600 text-gray-600 hover:bg-gray-100 rounded-lg cursor-pointer"
          >
            <svg
              width="24"
              height="24"
          ...
          {showFilter && (
            <div className="absolute z-10 mt-2 w-40 bg-white border border-gray-300 rounded-lg shadow-md">
      ...
      <div className="flex flex-row items-center justify-center gap-2">
        <div className="flex border-r-2 border-gray-600 pr-10">
          <button className="flex flex-row items-center justify-center px-4 py-3 gap-2 text-xl border-2 border-gray-600 text-gray-600 hover:bg-gray-100 rounded-lg cursor-pointer">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
