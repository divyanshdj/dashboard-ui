...
const Sidebar = () => {
  ...
  return (
    <div
      className={`${
        collapsed ? "w-20" : "w-56"
      } transition-all duration-300 border-r border-gray-300 h-screen bg-white`}
    >
      <div className="flex px-4 items-center justify-between h-16 w-full border-b border-gray-300">
        <div className="flex items-center space-x-2">
          ...
          {!collapsed && (
            <h2 className="text-lg font-semibold text-gray-800">Project M.</h2>
          )}
        </div>
        <button
        ...
        >
          {!collapsed ? (
            ...
            <svg
              ...
              id="fast-forward"
            >
              <path d="M 11.586,12 5.293,5.707 c -0.39,-0.39 -0.39,-1.024 0,-1.414 0.39,-0.39 1.024,-0.39 1.414,0 l 7,7 c 0.391,0.39 0.391,1.024 0,1.414 l -7,7 c -0.39,0.39 -1.024,0.39 -1.414,0 -0.39,-0.39 -0.39,-1.024 0,-1.414 z m 5,0 -6.293,-6.293 c -0.39,-0.39 -0.39,-1.024 0,-1.414 0.39,-0.39 1.024,-0.39 1.414,0 l 7,7 c 0.391,0.39 0.391,1.024 0,1.414 l -7,7 c -0.39,0.39 -1.024,0.39 -1.414,0 -0.39,-0.39 -0.39,-1.024 0,-1.414 z"></path>
            </svg>
          )}
        </button>
      </div>
      ...
      <div className="flex flex-col space-y-4">
        <div className="px-4 pb-2 flex items-center justify-between">
          {!collapsed && <h2 className="font-bold text-lg">My Projects</h2>}
        ...
        <div className="flex flex-col space-y-6">
          <div className="mx-2 flex items-center justify-between hover:bg-gray-100 cursor-pointer px-6 rounded-lg bg-gray-100">
            <div className="flex items-center space-x-3">
              ...
              {!collapsed && <h2 className="font-bold text-lg">Mobile App</h2>}
            </div>
            <svg
              width="15"
              height="4"
      ...
      {!collapsed && (
        <div className="mt-15 p-4 flex flex-col space-y-4 items-center justify-center">
          <div className="bg-gray-100 rounded-lg p-4 relative text-center">
            ...
            <h4 className="font-medium text-gray-800 mt-10">Thoughts Time</h4>
            <p className="text-sm text-gray-600 mt-1">
              We don’t have any notice for you, till then you can share your
              thoughts with your peers.
            </p>
            <button className="mt-2 text-sm text-center w-full py-1.5 bg-white border border-gray-200 rounded-md hover:bg-gray-50">
              Write a message
            </button>
          </div>
        </div>
